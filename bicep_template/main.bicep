...
param description string = 'test bicep creation of ai services resources'
param display_name string = 'bicep-test'
...
param deploymentUniqueName string = 'april'
var uniqueSuffix = substring(uniqueString('${resourceGroup().id}-${deploymentUniqueName}'), 0, 4)
